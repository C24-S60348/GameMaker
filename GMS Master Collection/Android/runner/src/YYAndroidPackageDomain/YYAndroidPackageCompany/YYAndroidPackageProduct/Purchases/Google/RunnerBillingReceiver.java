...
public class RunnerBillingReceiver extends BroadcastReceiver 
{
    ...
    public void onReceive(Context context, Intent intent) 
    {
        ...
        else if (RunnerBillingConsts.ACTION_NOTIFY.equals(action)) 
        {
            String notifyId = intent.getStringExtra(RunnerBillingConsts.NOTIFICATION_ID);
            Log.i("yoyo", "notifyId: " + notifyId);
    ...
    private void purchaseStateChanged(Context context, String signedData, String signature) 
    {
        ...
        intent.putExtra(RunnerBillingConsts.INAPP_SIGNED_DATA, signedData);
        intent.putExtra(RunnerBillingConsts.INAPP_SIGNATURE, signature);
    ...
    private void notify(Context context, String notifyId) 
    {
        ...
        intent.setClass(context, RunnerBillingService.class);
        intent.putExtra(RunnerBillingConsts.NOTIFICATION_ID, notifyId);
        context.startService(intent);
    }
    ...
    private void checkResponseCode(Context context, long requestId, int responseCodeIndex) 
    {
        ...
        intent.setClass(context, RunnerBillingService.class);
        intent.putExtra(RunnerBillingConsts.INAPP_REQUEST_ID, requestId);
        intent.putExtra(RunnerBillingConsts.INAPP_RESPONSE_CODE, responseCodeIndex);
        context.startService(intent);
    }
}
