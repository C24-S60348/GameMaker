 ...
 */
public class RunnerBillingConsts 
{
    ...
    public enum ResponseCode 
    {
        ...
        // Converts code to a ResponseCode and compares to the value provided
        public static boolean valueEquals(int index, ResponseCode responseCode)
        {
        	ResponseCode[] values = ResponseCode.values();
            if (index < 0 || index >= values.length) 
            {
            	if (values[index] == responseCode)
            	{
            		return true;
            	}
            }
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION = "${YYAndroidPackageName}.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION = "${YYAndroidPackageName}.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS = "${YYAndroidPackageName}.RESTORE_TRANSACTIONS";
