...
public class RunnerBillingSecurity 
{
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) 
    {
        if (signedData == null) 
        {
			Log.i("yoyo", "SECURITY: data is null");
            return null;
        }
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = RunnerBillingSecurity.getBase64EncodedPublicKey();
            PublicKey key = RunnerBillingSecurity.generatePublicKey(base64EncodedPublicKey);
            verified = RunnerBillingSecurity.verify(key, signedData, signature);
            if (!verified) 
            {
				Log.w("yoyo", "SECURITY: signature does not match data.");
                return null;
            }
        }
        ...
        if (!RunnerBillingSecurity.isNonceKnown(nonce)) {
			Log.w("yoyo", "SECURITY: Nonce not found: " + nonce);
            return null;
        }
    ...
    public static PublicKey generatePublicKey(String encodedPublicKey) 
    {
        try 
        {
            ...
            Log.e("yoyo", "SECURITY: Invalid key specification.");
            throw new IllegalArgumentException(e);
        } 
        catch (Base64DecoderException e) {
            Log.e("yoyo", "SECURITY: Base64 decoding failed.");
            throw new IllegalArgumentException(e);
        }
    }
    ...
    {        
        ...
        try 
        {
            ...
            {
                Log.e("yoyo", "SECURITY: Signature verification failed.");
                return false;
            }
            return true;
        } 
        catch (NoSuchAlgorithmException e) {
            Log.e("yoyo", "NoSuchAlgorithmException.");
        } 
        catch (InvalidKeyException e) {
            Log.e("yoyo", "Invalid key specification.");
        } 
        catch (SignatureException e) {
            Log.e("yoyo", "Signature exception.");
        } 
        catch (Base64DecoderException e) {
            Log.e("yoyo", "Base64 decoding failed.");
        }
        return false;
    }
}
